...
Para ver aplicaciones de ejemplo que integran MotorDsl en proyectos reales, consultá la sección de ejemplos:

📄 **[Ejemplos completos →](../11_examples/README.md)**

| Ejemplo | Nivel | Descripción |
|---------|-------|-------------|
| [ejemplo-01-simple](../11_examples/ejemplo-01-simple.md) | Básico | Aplicación de consola con template simple |
| [ejemplo-02-multa](../11_examples/ejemplo-02-multa.md) | Avanzado | App MAUI con multa de tránsito |
| [ejemplo-03-multaapp-nuget](../11_examples/ejemplo-03-multaapp-nuget.md) | Avanzado | App vía paquetes NuGet |
