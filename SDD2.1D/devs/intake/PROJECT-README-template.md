...
1. Copiar este archivo como `PROJECT-README-<nombre-solucion-kebab>_v1.0.md` en `/SDD2.1D/devs/intake/`.
...
Este documento alimenta las siguientes secciones SDD 2.1. La trazabilidad se aplica por proyecto según su `project_type`.
