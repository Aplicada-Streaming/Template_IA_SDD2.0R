...
1. Copiar este archivo como `SOLUTION-INTAKE-<nombre-solucion-kebab>_v1.0.md` en `/SDD2.1D/devs/intake/`.
...
Este documento alimenta las siguientes secciones SDD 2.1. La parte de negocio (A) es de nivel solución; la composición (B) deriva el manifiesto; la técnica (C) se aplica por proyecto.
