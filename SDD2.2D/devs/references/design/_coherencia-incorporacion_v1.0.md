...
Pase de verificación en lectura sobre la incorporación del catálogo de reglas de diseño (`devs/references/design/`) y su cableado en la metodología SDD 2.2. Cubre los archivos creados y editados en las fases 1 a 3, contra las invariantes D1–D8 del template y la trazabilidad esperada del catálogo.
...
| `devs/guides/marco-teorico-sdd2.2_v1.0.md` | `references/` sumado al mapa de carpetas del plano `devs/` (§1.5), nueva subsección §8.7 sobre el catálogo. | sin marca de versión interna; solo edición |
| `guides/guia-usuario-sdd2.2_v1.0.md` | Subárbol `references/design/` sumado al mapa de carpetas del plano `devs/` (§10.2). | sin marca de versión interna; solo edición |
...
| El marco teórico referencia el subárbol | Cumple | §1.5 (mapa de carpetas) y §8.7 de `marco-teorico-sdd2.2_v1.0.md` mencionan `devs/references/design/` y el modelo base→especialización. |
| La guía de usuario referencia el subárbol | Cumple | §10.2 de `guia-usuario-sdd2.2_v1.0.md` incluye `references/design/` en el árbol del plano `devs/` con su línea de propósito. |
